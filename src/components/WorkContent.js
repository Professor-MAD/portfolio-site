const workContent = [
  ...
  },
  {
    ...
    link: 'https://prod-mono-frontend.onrender.com/',
    icons: [
      '/images/react.png',
      '/images/tailwind.png',
      '/images/Typescript_logo_2020.svg.png',
...

  {
    ...
    logo: '/images/osr-screenshot-2.png',
    screenshot: '/images/osr-screenshot.png',
    github: 'https://github.com/Professor-MAD',
    link: 'https://www.onteorascholarship.com/',
    icons: [
      '/images/next.png',
      '/images/tailwind.png',
      '/images/Typescript_logo_2020.svg.png',
    ...
    description:
      'The Onteora Scholarship application is a full-stack web platform built to manage and review camp staff scholarship submissions. Applicants can submit detailed forms with optional file uploads. Admins have a private dashboard to view, search, and evaluate submissions. The frontend is built with Next.js and Tailwind CSS, while the backend uses AdonisJS with a PostgreSQL database hosted on Railway. Firebase handles secure file storage. The project includes custom authentication, real-time updates, and secure API integration.',
    fontFamily: 'Bellfoods',
    useVideo: false,
  },
